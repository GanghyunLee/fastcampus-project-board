...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // Then
        BDDMockito.then(articleRepository).should().save(any(Article.class)); // save를 1번 호출했는가?
    }
    ...
    void givenArticleId_whenDeletingArticle_thenDeletesArticle() {
        ...
        // Then
        BDDMockito.then(articleRepository).should().delete(any(Article.class)); // delete 1번 호출했는가?
    }
